#12. convnet_1CP1F_Sig_vLR_shuf.py
'''
1 convolutional-pooling layer, 1 Fully-connected layer, 1 softmax layer, Sigmoid, variable learning rate, shuffling of data  
'''
